...
from config.constants import TASK_STATUS, TASK_TYPE, TASK_SUPPORT_TYPE, TASK_FEEDBACK
...
class Task(models.Model):
    ...
    name = models.CharField(
        'Taskname', blank=False, null=False, db_index=True, max_length=50
    )
    ...
    session_video_link = models.CharField(
        'Session video link' ,  blank=True , null = True , max_length=200
    )
